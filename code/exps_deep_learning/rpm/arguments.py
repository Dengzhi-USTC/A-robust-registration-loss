...
def rpmnet_arguments():
    ...
    parser.add_argument(
        ...
        metavar='PATH',
        help=
        'path to the processed dataset. Default: ../datasets/modelnet40_ply_hdf5_2048'
    )
    parser.add_argument(
        '--dataset_type',
    ...
    parser.add_argument(
        ...
        type=float,
        help=
        'Approximate proportion of points to keep for partial overlap (Set to 1.0 to disable)'
    )
    # Model
    parser.add_argument(
        '--method',
    ...
    parser.add_argument(
        ...
        default=96,
        help=
        'Feature dimension (to compute distances on). Other numbers will be scaled accordingly'
    )
    parser.add_argument('--no_slack',
                        action='store_true',
    ...
    parser.add_argument(
        ...
        default=5,
        help=
        'Number of outer iterations used for registration (only during inference)'
    )
    ...
    parser.add_argument('--wt_inliers',
                        type=float,
                        default=1e-2,
    ...
    parser.add_argument(
        ...
        metavar='PATH',
        help=
        'Pretrained network to load from. Optional for train, required for inference.'
    )
    parser.add_argument(
        '--gpu',
        default=0,
        ...
        metavar='DEVICE',
        help=
        'GPU to use, ignored if no GPU is present. Set to negative to use cpu')
    return parser
...
def rpmnet_train_arguments():
    ...
    parser.add_argument(
        ...
        metavar='N',
        help=
        'Frequency of saving summary (number of steps if positive, number of epochs if negative)'
    )
    parser.add_argument(
        '--validate_every',
        default=-4,
        ...
        metavar='N',
        help=
        'Frequency of evaluation (number of steps if positive, number of epochs if negative).'
    ...
    parser.add_argument(
        ...
        default=2,
        help=
        'Number of outer iterations used for registration (only during training)'
    )

    # Add for our new network;
    # self.chamfer_dist = ChamferDistance()
    parser.add_argument('--frequency_save_results',
                        type=int,
                        default=10,
                        help='frequency of save results')
    parser.add_argument('--frequency_update_lr',
                        type=int,
                        default=1000,
    ...
    parser.add_argument('--counter',
                        type=int,
                        default=0,
                        help='counter the training process')
    parser.add_argument('--whole_epoch',
                        type=int,
                        default=0,
                        help='whole_epoch of the  training process')
    parser.add_argument('--re_load_model_path',
                        type=str,
                        default="",
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help='Whether to use pretrained model, use gt loss to survised;')

    parser.add_argument('--exps_path',
                        type=str,
                        default='./results',
...
def rpmnet_eval_arguments():
    ...
    # settings for input data_loader
    parser.add_argument('--test_category_file',
                        type=str,
                        metavar='PATH',
    ...
    parser.add_argument('--eval_save_path',
                        type=str,
