...
class CheckPointManager(object):
    ...
    def __init__(self,
        ...
        # Use the variable to define it!
        self._save_path = save_path + '-{}.pth' if save_path is not None else None
        self._logger = logging.getLogger(self.__class__.__name__)
        self._checkpoints_fname = os.path.join(self._ckpt_dir,
                                               'checkpoints.txt')
    ...
    def _save_checkpoint(self, step, model, optimizer, score):
        ...
        if score > self._best_score:
            ...
            self._logger.info(
                'Checkpoint is current best, score={:.3g}'.format(
                    self._best_score))
    ...
    def _remove_old_checkpoints(self):
        while len(self._checkpoints_buffer) > self._max_to_keep:
            ...
            if to_remove[1] > self._next_save_time:
                ...
                self._next_save_time = to_remove[
                    1] + self._keep_checkpoint_every_n_hours * 3600
            else:
